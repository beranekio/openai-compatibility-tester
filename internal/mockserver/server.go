...
func newServerWithRoutes() *Server {
	...
	mux.HandleFunc("POST /v1/content_provenance_checks", handleContentProvenanceChecks)
	...
	mux.HandleFunc("POST /v1/files", s.handleFileCreate)
	mux.HandleFunc("GET /v1/files", s.handleFileList)
	...
	mux.HandleFunc("POST /v1/vector_stores", s.handleVectorStoreCreate)
	mux.HandleFunc("GET /v1/vector_stores", s.handleVectorStoreList)
	mux.HandleFunc("GET /v1/vector_stores/{id}", s.handleVectorStoreGet)
	...
	mux.HandleFunc("GET /v1/videos/{id}/{rest}", s.handleVideoSubResource)
	mux.HandleFunc("POST /v1/videos/edits", s.handleVideoEdit)
	mux.HandleFunc("POST /v1/videos/extensions", s.handleVideoExtend)
	mux.HandleFunc("POST /v1/videos/{id}/remix", s.handleVideoRemix)
	mux.HandleFunc("POST /v1/videos/characters", s.handleVideoCharacterCreate)
	...
	mux.HandleFunc("POST /v1/fine_tuning/jobs", s.handleFineTuningJobCreate)
	mux.HandleFunc("GET /v1/fine_tuning/jobs", s.handleFineTuningJobList)
	mux.HandleFunc("GET /v1/fine_tuning/jobs/{id}", s.handleFineTuningJobGet)
	mux.HandleFunc("GET /v1/fine_tuning/jobs/{id}/events", s.handleFineTuningJobEventList)
