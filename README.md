...
| `skills` | `client.Skills.New`, `Get`, `Update`, `List`, `Delete` | `POST/GET/DELETE /v1/skills` |
| `skill_versions` | `client.Skills.Versions.New`, `Get`, `List`, `Delete`; `client.Skills.Content.Get`; `client.Skills.Versions.Content.Get` | `POST/GET/DELETE /v1/skills/{id}/versions`, `GET /v1/skills/{id}/content`, `GET /v1/skills/{id}/versions/{version}/content` |
